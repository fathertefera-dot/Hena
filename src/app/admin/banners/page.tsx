...
export default function AdminBannersPage() {
  ...
  return <BannersClient initialBanners={banners} onRefresh={() => getAllBanners().then(setBanners)} />
}

function BannersClient({ initialBanners, onRefresh }: { initialBanners: Banner[]; onRefresh: () => void }) {
  ...
  const onSubmit = (data: BannerFormValues) => {
    ...
    startTransition(async () => {
      const result = editingBanner
        ? await updateBanner(editingBanner.id, data, selectedFile)
        : await createBanner(data, selectedFile)
